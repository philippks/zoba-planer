...
{
	if (region.ar.U === region.aG.U)
	{
		return 'on line ' + region.ar.U;
	}
	return 'on lines ' + region.ar.U + ' through ' + region.aG.U;
}
...
var $author$project$Worker$CustomizedFiles = F6(
	function (auth, shared, sharedModel, sharedMsg, effect, view) {
		return {ae: auth, ag: effect, ao: shared, ap: sharedModel, aq: sharedMsg, av: view};
	});
var $elm$core$Basics$identity = function (x) {
	return x;
};
var $author$project$CustomizableFile$CustomizableFile = $elm$core$Basics$identity;
var $author$project$CustomizableFile$Internals = F2(
	function (filepath, file) {
		return {_: file, aJ: filepath};
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$emptyState = {Z: _List_Nil, I: _List_Nil};
var $stil4m$elm_syntax$Elm$Syntax$File$File = F4(
	function (moduleDefinition, imports, declarations, comments) {
		return {Z: comments, aF: declarations, aQ: imports, bR: moduleDefinition};
	});
...
var $stil4m$elm_syntax$Elm$Parser$State$getComments = function (_v0) {
	var s = _v0;
	return $elm$core$List$reverse(s.Z);
};
...
var $stil4m$elm_syntax$Elm$Syntax$Range$compareLocations = F2(
	function (left, right) {
		return (_Utils_cmp(left.bb, right.bb) < 0) ? 0 : ((_Utils_cmp(left.bb, right.bb) > 0) ? 2 : A2($elm$core$Basics$compare, left.aC, right.aC));
	});
...
var $stil4m$elm_syntax$Elm$Syntax$Expression$LetBlock = F2(
	function (declarations, expression) {
		return {aF: declarations, bG: expression};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {aB: col, bx: contextStack, a3: problem, bb: row};
	});
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.bb, s.aB, x, s.c));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.bb, s.aB, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{aB: newCol, c: s.c, d: s.d, b: newOffset, bb: newRow, a: s.a});
	};
};
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{aB: 1, c: s.c, d: s.d, b: s.b + 1, bb: s.bb + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{aB: s.aB + 1, c: s.c, d: s.d, b: newOffset, bb: s.bb, a: s.a}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{aB: col, c: s0.c, d: s0.d, b: offset, bb: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.bb, s.aB, s);
	};
};
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								aG: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(end),
								ar: $stil4m$elm_syntax$Elm$Parser$Node$asPointerLocation(start)
							});
					}),
				A2(
					$stil4m$elm_syntax$Combine$andMap,
...
var $elm$parser$Parser$Advanced$varHelp = F7(
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {aB: col, c: context, d: indent, b: offset, bb: row, a: src};
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		...
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.aS, s.b + 1, s.bb + 1, 1, s.a, s.d, s.c) : A7($elm$parser$Parser$Advanced$varHelp, i.aS, firstOffset, s.bb, s.aB + 1, s.a, s.d, s.c);
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{aI: $elm$parser$Parser$ExpectingVariable, aS: i.aS, ba: i.ba, ar: i.ar});
};
	...
	$elm$parser$Parser$variable(
		{
			...
			ba: $elm$core$Set$fromList($stil4m$elm_syntax$Elm$Parser$Tokens$reservedList),
			ar: $miniBill$elm_unicode$Unicode$isLower
		}));
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.bb, s.aB, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.b, s.bb, s.aB, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $stil4m$elm_syntax$Elm$Parser$State$addComment = F2(
	function (pair, _v0) {
		...
		return _Utils_update(
			s,
			{
				Z: A2($elm$core$List$cons, pair, s.Z)
			});
	});
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {aB: s.aB + (newOffset - s.b), c: s.c, d: s.d, b: newOffset, bb: s.bb, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.bb, s.aB - (floatOffset + s.b), invalid, s.c));
		} else {
	...
	return $elm$parser$Parser$Advanced$number(
		{
			...
			aI: $elm$parser$Parser$ExpectingNumber,
			aK: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingFloat, i.aK),
			aO: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingHex, i.aO),
			aT: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingInt, i.aT),
			bP: $elm$parser$Parser$ExpectingNumber,
			a$: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingOctal, i.a$)
		});
};
		...
		return $elm$parser$Parser$number(
			{
				...
				aK: $elm$core$Maybe$Just(floatf),
				aO: $elm$core$Maybe$Just(hexf),
				aT: $elm$core$Maybe$Just(intf),
	...
	$elm$parser$Parser$variable(
		{
			...
			ba: $elm$core$Set$fromList($stil4m$elm_syntax$Elm$Parser$Tokens$reservedList),
			ar: $miniBill$elm_unicode$Unicode$isUpper
		}));
	...
	return $stil4m$elm_syntax$Elm$Syntax$Range$combine(
		_List_fromArray(
			[
				...
				if (!_v0.$) {
					...
					return A2(
						...
						function (_v3) {
							...
							$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.by).aa),
						A2(
							$elm$core$Maybe$map,
							function (_v1) {
								var value = _v1.b;
				...
				$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.by).bG)
			]));
};
var $stil4m$elm_syntax$Elm$Syntax$Signature$Signature = F2(
	function (name, typeAnnotation) {
		return {aa: name, b1: typeAnnotation};
	});
															...
															F3(
																function (condition, ifTrue, ifFalse) {
																	return A2(
																		$stil4m$elm_syntax$Elm$Syntax$Node$Node,
																		{
																			aG: $stil4m$elm_syntax$Elm$Syntax$Node$range(ifFalse).aG,
																			ar: current.ar
																		},
										...
										F2(
											function (args, expr) {
												return A2(
													$stil4m$elm_syntax$Elm$Syntax$Node$Node,
													{
														aG: $stil4m$elm_syntax$Elm$Syntax$Node$range(expr).aG,
														ar: current.ar
													},
...
var $stil4m$elm_syntax$Elm$Syntax$Infix$Infix = F4(
	function (direction, precedence, operator, _function) {
		return {bz: direction, bJ: _function, a0: operator, bY: precedence};
	});
				...
				return A2(
					...
					$stil4m$elm_syntax$Elm$Syntax$Range$combine(
						_List_fromArray(
							[
								current,
								$stil4m$elm_syntax$Elm$Syntax$Node$range(inf.bJ)
							])),
...
var $stil4m$elm_syntax$Elm$Syntax$Type$Type = F4(
	function (documentation, name, generics, constructors) {
		return {bw: constructors, bA: documentation, aM: generics, aa: name};
	});
var $stil4m$elm_syntax$Elm$Syntax$TypeAlias$TypeAlias = F4(
	function (documentation, name, generics, typeAnnotation) {
		return {bA: documentation, aM: generics, aa: name, b1: typeAnnotation};
	});
							...
							return A2(
								...
								$stil4m$elm_syntax$Elm$Syntax$Range$combine(
									_List_fromArray(
										[
											start,
											$stil4m$elm_syntax$Elm$Syntax$Node$range(typeAlias.b1)
										])),
								typeAlias);
						},
						A2(
...
var $stil4m$elm_syntax$Elm$Syntax$Import$Import = F3(
	function (moduleName, moduleAlias, exposingList) {
		return {ah: exposingList, t: moduleAlias, aZ: moduleName};
	});
			...
			return A2(
				...
				$stil4m$elm_syntax$Combine$withLocation(
					function (end) {
						return $stil4m$elm_syntax$Combine$succeed(
							{
								aG: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(end),
								ar: $stil4m$elm_syntax$Elm$Parser$Ranges$asPointerLocation(start)
							});
					}),
				p);
		});
	...
	function (start, imp) {
		var allRanges = _List_fromArray(
			[
				...
				A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$range, imp.t)
			]);
		return A2(
			$stil4m$elm_syntax$Elm$Syntax$Node$Node,
			$stil4m$elm_syntax$Elm$Syntax$Range$combine(
	...
	var createEffectModule = F3(
		function (name, whereClauses, exp) {
			return $stil4m$elm_syntax$Elm$Syntax$Module$EffectModule(
				{af: whereClauses.af, ah: exp, aZ: name, at: whereClauses.at});
		});
	return A2(
		$stil4m$elm_syntax$Combine$andMap,
		$stil4m$elm_syntax$Elm$Parser$Node$parser($stil4m$elm_syntax$Elm$Parser$Expose$exposeDefinition),
...
var $stil4m$elm_syntax$Elm$Syntax$Module$DefaultModuleData = F2(
	function (moduleName, exposingList) {
		return {ah: exposingList, aZ: moduleName};
	});
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {aB: col, a3: problem, bb: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.bb, p.aB, p.a3);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{aB: 1, c: _List_Nil, d: 1, b: 0, bb: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
	...
	function (range, comments, previousComments) {
		...
		while (true) {
			if (!comments.b) {
				...
				var _v1 = A2($elm$core$Basics$compare, commentRange.aG.bb + 1, range.ar.bb);
				switch (_v1) {
					case 1:
...
var $stil4m$elm_syntax$Elm$Processing$addDocumentation = F3(
	function (howToUpdate, declaration, file) {
		...
		if (!maybeDoc.$) {
			...
			return {
				aF: A2($elm$core$List$cons, declaration, file.aF),
				n: A2($elm$core$List$cons, previous, file.n),
				q: remaining
			};
		}
				...
				function (x) {
					return _Utils_Tuple2(
						...
						A2(
							$elm$core$Maybe$withDefault,
							{
								bz: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 0),
								bJ: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 'todo'),
								a0: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, x),
								bY: A2($stil4m$elm_syntax$Elm$Syntax$Node$Node, $stil4m$elm_syntax$Elm$Syntax$Range$emptyRange, 5)
							},
				...
				A2(
					...
					function (_v0) {
						...
						return A4(
							...
							$stil4m$elm_syntax$Elm$Syntax$Node$value(infix_.a0),
							$stil4m$elm_syntax$Elm$Syntax$Node$value(infix_.bz),
							A2(
								$stil4m$elm_syntax$Elm$Syntax$Node$Node,
								$stil4m$elm_syntax$Elm$Syntax$Range$combine(
				...
				switch (expression.$) {
					...
					case 15:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$LetExpression(
							{
								aF: A2($stil4m$elm_syntax$Elm$Processing$visitLetDeclarations, table, letBlock.aF),
								bG: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, letBlock.bG)
							});
					case 16:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$CaseExpression(
							{
								bt: A2(
									...
									$elm$core$Tuple$mapSecond(
										$stil4m$elm_syntax$Elm$Processing$visitExpression(table)),
									caseBlock.bt),
								bG: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, caseBlock.bG)
							});
					case 17:
						...
						return $stil4m$elm_syntax$Elm$Syntax$Expression$LambdaExpression(
							_Utils_update(
								lambda,
								{
									bG: A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, lambda.bG)
								}));
					case 18:
...
var $stil4m$elm_syntax$Elm$Processing$visitFunctionDecl = F2(
	function (table, _function) {
		...
		return _Utils_update(
			_function,
			{by: newFunctionDeclaration});
	});
var $stil4m$elm_syntax$Elm$Processing$visitFunctionDeclaration = F2(
	function (table, functionDeclaration) {
		var newExpression = A2($stil4m$elm_syntax$Elm$Processing$visitExpression, table, functionDeclaration.bG);
		return _Utils_update(
			functionDeclaration,
			{bG: newExpression});
	});
...
var $stil4m$elm_syntax$Elm$Processing$attachDocumentationAndFixOperators = F3(
	function (table, declaration, context) {
		...
		switch (_v0.$) {
			...
			case 3:
				return {
					aF: A2($elm$core$List$cons, declaration, context.aF),
					n: context.n,
					q: context.q
				};
			case 4:
...
var $stil4m$elm_syntax$Elm$Processing$buildSingle = F2(
	function (moduleIndex, imp) {
		var _v0 = A2($elm$core$Maybe$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, imp.ah);
		if (_v0.$ === 1) {
			return _List_Nil;
		} else {
			if (!_v0.a.$) {
					...
					return A2(
						...
						function (elem) {
							return A2(
								...
								$stil4m$elm_syntax$Elm$Syntax$Node$value(elem.a0),
								importedOperators);
						},
...
var $stil4m$elm_syntax$Elm$RawFile$imports = function (_v0) {
	var file = _v0;
	return A2($elm$core$List$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, file.aQ);
};
	...
	function (rawFile, _v0) {
		...
		return $elm$core$Dict$fromList(
			A2(
				...
				function (x) {
					return _Utils_Tuple2(
						$stil4m$elm_syntax$Elm$Syntax$Node$value(x.a0),
						x);
				},
				A2(
...
var $stil4m$elm_syntax$Elm$Processing$process = F2(
	function (processContext, rawFile) {
		...
		var changes = A3(
			...
			{aF: _List_Nil, n: _List_Nil, q: file.Z},
			file.aF);
		return {
			Z: $elm$core$List$concat(
				$elm$core$List$reverse(
					A2($elm$core$List$cons, changes.q, changes.n))),
			aF: $elm$core$List$reverse(changes.aF),
			aQ: file.aQ,
			bR: file.bR
		};
	});
...
var $author$project$CustomizableFile$fileDecoder = function () {
	var toMaybeFile = function (contents) {
		return A2(
			$elm$core$Maybe$map,
	...
	return A2(
		...
		function (str) {
			var _v0 = toMaybeFile(str);
			if (!_v0.$) {
				var file = _v0.a;
				return $elm$json$Json$Decode$succeed(file);
			} else {
				return $elm$json$Json$Decode$fail('Could not decode file');
			}
		},
		$elm$json$Json$Decode$string);
}();
var $author$project$Filepath$Filepath = $elm$core$Basics$identity;
var $author$project$Filepath$fromList = $elm$core$Basics$identity;
var $elm$json$Json$Decode$map = _Json_map1;
var $elm$json$Json$Decode$map2 = _Json_map2;
var $author$project$CustomizableFile$decoder = function (filepath_) {
	return A2(
		$elm$json$Json$Decode$map,
		$elm$core$Basics$identity,
		A3(
			$elm$json$Json$Decode$map2,
			$author$project$CustomizableFile$Internals,
			$elm$json$Json$Decode$succeed(
				$author$project$Filepath$fromList(filepath_)),
			$author$project$CustomizableFile$fileDecoder));
};
...
var $author$project$Worker$customizedFilesDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Worker$CustomizedFiles,
	$elm$json$Json$Decode$maybe(
		A2(
			$elm$json$Json$Decode$field,
			'auth',
			$author$project$CustomizableFile$decoder(
				_Utils_Tuple2('Auth', _List_Nil)))),
	$elm$json$Json$Decode$maybe(
		A2(
			$elm$json$Json$Decode$field,
			'shared',
			$author$project$CustomizableFile$decoder(
				_Utils_Tuple2('Shared', _List_Nil)))),
	$elm$json$Json$Decode$maybe(
		A2(
			$elm$json$Json$Decode$field,
			'sharedModel',
	...
	$elm$json$Json$Decode$maybe(
		A2(
			...
			'effect',
			$author$project$CustomizableFile$decoder(
				_Utils_Tuple2('Effect', _List_Nil)))),
	$elm$json$Json$Decode$maybe(
		A2(
			$elm$json$Json$Decode$field,
			'view',
			$author$project$CustomizableFile$decoder(
				_Utils_Tuple2('View', _List_Nil)))));
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $author$project$Layout$Internals = F2(
	function (filepath, file) {
		return {_: file, aJ: filepath};
	});
var $author$project$Layout$Layout = $elm$core$Basics$identity;
var $elm$json$Json$Decode$list = _Json_decodeList;
var $author$project$Filepath$decoder = function (options) {
	return A2(
		$elm$json$Json$Decode$andThen,
		function (filepathStrings) {
			if (!filepathStrings.b) {
				return $elm$json$Json$Decode$fail('Filepath cannot be empty');
			} else {
				return $elm$json$Json$Decode$succeed(
					_Utils_Tuple2(options.bI, filepathStrings));
			}
		},
		$elm$json$Json$Decode$list($elm$json$Json$Decode$string));
};
var $author$project$Layout$fileDecoder = function () {
	var toMaybeFile = function (contents) {
		return A2(
			$elm$core$Maybe$map,
			$stil4m$elm_syntax$Elm$Processing$process($stil4m$elm_syntax$Elm$Processing$init),
...
var $author$project$Layout$decoder = A2(
	...
	A3(
		$elm$json$Json$Decode$map2,
		$author$project$Layout$Internals,
		A2(
			$elm$json$Json$Decode$field,
			'filepath',
			$author$project$Filepath$decoder(
				{bI: 'Layouts'})),
		A2($elm$json$Json$Decode$field, 'contents', $author$project$Layout$fileDecoder)));
var $author$project$Page$Internals = F2(
	function (filepath, file) {
		return {_: file, aJ: filepath};
	});
var $author$project$Page$Page = $elm$core$Basics$identity;
var $author$project$Page$fileDecoder = function () {
	var toMaybeFile = function (contents) {
		return A2(
			$elm$core$Maybe$map,
			$stil4m$elm_syntax$Elm$Processing$process($stil4m$elm_syntax$Elm$Processing$init),
...
var $author$project$Page$decoder = A2(
	$elm$json$Json$Decode$map,
	$elm$core$Basics$identity,
	A3(
		$elm$json$Json$Decode$map2,
		$author$project$Page$Internals,
		A2(
			$elm$json$Json$Decode$field,
			'filepath',
			$author$project$Filepath$decoder(
				{bI: 'Pages'})),
		A2($elm$json$Json$Decode$field, 'contents', $author$project$Page$fileDecoder)));
var $author$project$Layout$filepath = function (_v0) {
	var layout = _v0;
	return layout.aJ;
};
var $author$project$Extras$ElmSyntax$isNotExposing = F2(
	function (targetName, file) {
		var moduleDefinition = function () {
			var _v2 = $stil4m$elm_syntax$Elm$Syntax$Node$value(file.bR);
			switch (_v2.$) {
				case 0:
					var data = _v2.a;
					return data;
				...
				default:
					var data = _v2.a;
					return {ah: data.ah, aZ: data.aZ};
			}
		}();
		var exposingList = $stil4m$elm_syntax$Elm$Syntax$Node$value(moduleDefinition.ah);
		if (!exposingList.$) {
			return false;
		} else {
			var nodes = exposingList.a;
			var toName = function (node) {
			...
			var topLevelExposeList = A2($elm$core$List$map, toName, nodes);
			return !A2($elm$core$List$member, targetName, topLevelExposeList);
		}
	});
var $author$project$Layout$isNotExposingLayoutFunction = function (_v0) {
	var layout = _v0;
	return A2($author$project$Extras$ElmSyntax$isNotExposing, 'layout', layout._);
};
var $author$project$Layout$isNotExposingModelType = function (_v0) {
	var layout = _v0;
	return A2($author$project$Extras$ElmSyntax$isNotExposing, 'Model', layout._);
};
var $author$project$Layout$isNotExposingMsgType = function (_v0) {
	var layout = _v0;
	return A2($author$project$Extras$ElmSyntax$isNotExposing, 'Msg', layout._);
};
var $author$project$Layout$isNotExposingPropsType = function (_v0) {
	var layout = _v0;
	return A2($author$project$Extras$ElmSyntax$isNotExposing, 'Props', layout._);
};
var $author$project$Error$GREEN = 3;
var $author$project$Error$StyledText = function (a) {
	return {$: 1, a: a};
};
var $author$project$Error$green = function (str) {
	return $author$project$Error$StyledText(
		{
			F: false,
			G: $elm$core$Maybe$Just(3),
			L: str,
			N: false
		});
};
var $author$project$Error$Error = $elm$core$Basics$identity;
var $author$project$Error$new = function (options) {
	return options;
};
...
var $author$project$Error$PlainText = function (a) {
	return {$: 0, a: a};
};
var $author$project$Error$text = function (str) {
	return $author$project$Error$PlainText(str);
};
var $author$project$Filepath$toModuleName = function (_v0) {
	var _v1 = _v0;
	var first = _v1.a;
	var rest = _v1.b;
	return A2(
...
var $author$project$Filepath$toRelativeFilepath = function (_v0) {
	var _v1 = _v0;
	var first = _v1.a;
	var rest = _v1.b;
	return 'src/' + (A2(
		$elm$core$String$join,
		'/',
		A2($elm$core$List$cons, first, rest)) + '.elm');
};
var $author$project$Error$underline = function (str) {
	return $author$project$Error$StyledText(
		{F: false, G: $elm$core$Maybe$Nothing, L: str, N: true});
};
var $author$project$Error$YELLOW = 2;
var $author$project$Error$yellow = function (str) {
	return $author$project$Error$StyledText(
		{
			F: false,
			G: $elm$core$Maybe$Just(2),
			L: str,
			N: false
		});
};
var $author$project$Worker$missingFunctionOrTypeError = function (options) {
	var moduleName = $author$project$Filepath$toModuleName(options.aJ);
	return $author$project$Error$new(
		{
			bQ: _List_fromArray(
				[
					$author$project$Error$text('I expected this module to expose a '),
					$author$project$Error$yellow(
					A3($elm$core$String$replace, '{{name}}', options.aa, '{{name}}')),
					$author$project$Error$text(
					A3($elm$core$String$replace, '{{typeOrFunction}}', options.X, ' {{typeOrFunction}}:\n\n')),
					$author$project$Error$text('1|  module '),
					$author$project$Error$yellow(moduleName),
					$author$project$Error$text(
					A3($elm$core$String$replace, '{{name}}', options.aa, ' exposing ({{name}})\n')),
					$author$project$Error$text(
					A2(
						$elm$core$String$repeat,
						22 + $elm$core$String$length(moduleName),
						' ')),
					$author$project$Error$green(
					A2(
						$elm$core$String$repeat,
						$elm$core$String$length(options.aa),
						'^')),
					$author$project$Error$text('\nThis value is used internally by Elm Land, so it will need to be accessible\noutside of the current module.\n\n'),
					$author$project$Error$underline('Hint:'),
					$author$project$Error$text(
					A3(
						$elm$core$String$replace,
						'{{typeOrFunction}}',
						$elm$core$String$toLower(options.X),
						' Read https://elm.land/problems#missing-exposed-{{typeOrFunction}} to learn more'))
				]),
			bX: $author$project$Filepath$toRelativeFilepath(options.aJ),
			b0: A3(
				$elm$core$String$replace,
				'{{typeOrFunction}}',
				options.X,
				A3($elm$core$String$replace, '{{name}}', options.aa, 'Missing exposed {{typeOrFunction}}'))
		});
};
var $author$project$Worker$missingFunctionError = function (options) {
	return $author$project$Worker$missingFunctionOrTypeError(
		{aJ: options.aJ, l: options.l, aa: options.aa, X: 'function'});
};
...
var $author$project$Filepath$fromPascalCaseToCamelCase = function (str) {
...
var $author$project$Filepath$toRouteParamsRecordString = function (_v0) {
	var _v1 = _v0;
	var first = _v1.a;
	var rest = _v1.b;
	var isDynamic = function (str) {
		return (str !== 'ALL_') && ((str !== 'NotFound_') && A2($elm$core$String$endsWith, '_', str));
	};
	var filepath = A2($elm$core$List$cons, first, rest);
	var hasNoDynamicSegments = $elm$core$List$isEmpty(
		A2(
			$elm$core$List$filter,
			function (str) {
				return (str === 'ALL_') || isDynamic(str);
			},
			filepath));
	...
	if (((filepath.b && filepath.b.b) && (filepath.b.a === 'Home_')) && (!filepath.b.b.b)) {
		var _v3 = filepath.b;
		return '()';
	} else {
		return hasNoDynamicSegments ? '()' : $author$project$CodeGen$Annotation$toString(
			$author$project$CodeGen$Annotation$record(
				addConditionalCatchAllParameters(
					A2(
						$elm$core$List$map,
						function (fieldName) {
							return (fieldName === 'all_') ? _Utils_Tuple2(
								'all_',
								$author$project$CodeGen$Annotation$type_('List String')) : _Utils_Tuple2(fieldName, $author$project$CodeGen$Annotation$string);
						},
						A2(
							$elm$core$List$map,
							$author$project$Filepath$fromPascalCaseToCamelCase,
							A2(
								$elm$core$List$map,
								$elm$core$String$dropRight(1),
								A2($elm$core$List$filter, isDynamic, filepath)))))));
	}
};
var $author$project$Worker$missingFunctionAnnotationError = F2(
	function (_v0, options) {
		var functionName = _v0.y;
		var validAnnotations = _v0.E;
		var units = ($elm$core$List$length(validAnnotations) === 1) ? 'this annotation' : 'one of these annotations';
		var params = $author$project$Filepath$toRouteParamsRecordString(options.aJ);
		return $author$project$Error$new(
			{
				bQ: $elm$core$List$concat(
					_List_fromArray(
						[
							_List_fromArray(
							[
								$author$project$Error$text('I could not find a type annotation for your '),
								$author$project$Error$yellow(functionName),
								$author$project$Error$text(
								A3($elm$core$String$replace, '{{units}}', units, ' function.\n\nI recommend {{units}}:\n\n'))
							]),
							A2(
							$elm$core$List$concatMap,
							function (anno) {
								return _List_fromArray(
									[
										$author$project$Error$text(
										A3($elm$core$String$replace, '{{functionName}}', functionName, '  {{functionName}} : ')),
										$author$project$Error$yellow(anno + '\n\n')
									]);
							},
							validAnnotations),
							_List_fromArray(
							[
								$author$project$Error$text('Although Elm annotations are optional, Elm Land requires an annotation for\nthis particular function to avoid showing errors in generated code.\n\n'),
								$author$project$Error$underline('Hint:'),
								$author$project$Error$text(' Read https://elm.land/problems#missing-type-annotation to learn more')
							])
						])),
				bX: $author$project$Filepath$toRelativeFilepath(options.aJ),
				b0: 'Missing type annotation'
			});
	});
var $author$project$Filepath$toParentLayoutModuleName = function (filepath) {
	var _v0 = A2(
		$elm$core$String$split,
		'.',
		$author$project$Filepath$toModuleName(filepath));
	if (!_v0.b) {
		return $elm$core$Maybe$Nothing;
	} else {
		if (!_v0.b.b) {
...
var $author$project$Layout$toValidLayoutFunctionAnnotations = function (parentLayoutModuleName) {
	var parentPropsWithoutContentMsg = function () {
		if (!parentLayoutModuleName.$) {
			var str = parentLayoutModuleName.a;
			return str + '.Props';
		} else {
			return '()';
		}
	}();
	var parentPropsWithContentMsg = function () {
		if (!parentLayoutModuleName.$) {
			var str = parentLayoutModuleName.a;
			return '(' + (str + '.Props contentMsg)');
		} else {
			return '()';
		}
	}();
	return A2(
		...
		function (parentProps) {
			return _List_fromArray(
				[
					A3($elm$core$String$replace, '${parentProps}', parentProps, 'Props -> Shared.Model -> Route () -> Layout ${parentProps} Model Msg contentMsg'),
					A3($elm$core$String$replace, '${parentProps}', parentProps, 'Props contentMsg -> Shared.Model -> Route () -> Layout ${parentProps} Model Msg contentMsg')
				]);
		},
		_List_fromArray(
			[parentPropsWithoutContentMsg, parentPropsWithContentMsg]));
};
var $author$project$Worker$validLayoutFunctionAnnotations = function (filepath) {
	return $author$project$Layout$toValidLayoutFunctionAnnotations(
		$author$project$Filepath$toParentLayoutModuleName(filepath));
};
var $author$project$Worker$missingLayoutAnnotationError = function (options) {
	return A2(
		$author$project$Worker$missingFunctionAnnotationError,
		{
			y: 'layout',
			E: $author$project$Worker$validLayoutFunctionAnnotations(options.aJ)
		},
		options);
};
var $author$project$Worker$missingTypeError = function (options) {
	return $author$project$Worker$missingFunctionOrTypeError(
		{aJ: options.aJ, l: options.l, aa: options.aa, X: 'type'});
};
var $author$project$Extras$ElmSyntax$findFunction = F2(
	function (functionName, file) {
		var toMaybeFunctionExpression = function (declaration) {
			if (!declaration.$) {
				var _function = declaration.a;
				return $elm$core$Maybe$Just(_function);
			} else {
				return $elm$core$Maybe$Nothing;
			}
		};
		var isFunctionWithName = F2(
			function (targetName, _function) {
				return _Utils_eq(
					targetName,
					$stil4m$elm_syntax$Elm$Syntax$Node$value(
						$stil4m$elm_syntax$Elm$Syntax$Node$value(_function.by).aa));
		...
		return $elm$core$List$head(
			A2(
				$elm$core$List$filter,
				isFunctionWithName(functionName),
				A2(
					$elm$core$List$filterMap,
					toMaybeFunctionExpression,
					A2($elm$core$List$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, file.aF))));
	});
var $author$project$Extras$ElmSyntax$addParensIf = F2(
...
var $author$project$Extras$ElmSyntax$fromModuleNodeToString = function (node) {
...
var $author$project$Extras$ElmSyntax$isFunctionAnnotation = function (anno) {
	if (anno.$ === 6) {
		return true;
	} else {
		return false;
...
var $author$project$Extras$ElmSyntax$fromAnnotationToString = function (typeAnnotation) {
	return A2($author$project$Extras$ElmSyntax$fromAnnotationToStringHelper, false, typeAnnotation);
};
var $author$project$Extras$ElmSyntax$fromAnnotationToStringHelper = F2(
	function (needsParens, typeAnnotation) {
		switch (typeAnnotation.$) {
			...
			case 1:
				if (!typeAnnotation.b.b) {
					var firstNode = typeAnnotation.a;
					return $author$project$Extras$ElmSyntax$fromModuleNodeToString(firstNode);
				} else {
					if (!typeAnnotation.b.b.b) {
						...
						var otherNode = _v2.a;
						return A2(
							$author$project$Extras$ElmSyntax$addParensIf,
							needsParens,
							A2(
								$elm$core$String$join,
								' ',
								_List_fromArray(
									[
										$author$project$Extras$ElmSyntax$fromModuleNodeToString(firstNode),
										A2(
										$author$project$Extras$ElmSyntax$fromAnnotationToStringHelper,
										true,
										$stil4m$elm_syntax$Elm$Syntax$Node$value(otherNode))
									])));
					} else {
						var firstNode = typeAnnotation.a;
						var restOfNodes = typeAnnotation.b;
						return A2(
							$author$project$Extras$ElmSyntax$addParensIf,
							needsParens,
							A2(
								...
								A2(
									...
									A2(
										...
										A2(
											...
											$author$project$Extras$ElmSyntax$fromAnnotationToStringHelper(true),
											$stil4m$elm_syntax$Elm$Syntax$Node$value),
										restOfNodes))));
					}
				}
				...
				if (!typeAnnotation.a.b) {
					...
					return '( ' + (A2(
						...
						A2(
							...
							A2(
								$elm$core$Basics$composeL,
								$author$project$Extras$ElmSyntax$fromAnnotationToStringHelper(false),
								$stil4m$elm_syntax$Elm$Syntax$Node$value),
							list)) + ' )');
				}
			case 4:
				if (!typeAnnotation.a.b) {
					...
					var recordFieldNodes = typeAnnotation.a;
					return '{ ' + (A2(
						$elm$core$String$join,
						', ',
						A2(
							$elm$core$List$map,
							$author$project$Extras$ElmSyntax$fromRecordFieldToString,
							A2($elm$core$List$map, $stil4m$elm_syntax$Elm$Syntax$Node$value, recordFieldNodes))) + ' }');
				}
			case 5:
				var varNameNode = typeAnnotation.a;
				var recordDefinitionNode = typeAnnotation.b;
				var _v3 = $stil4m$elm_syntax$Elm$Syntax$Node$value(recordDefinitionNode);
				if (!_v3.b) {
					return '{}';
				} else {
					var recordFieldNodes = _v3;
					return '{ ' + ($stil4m$elm_syntax$Elm$Syntax$Node$value(varNameNode) + (' ' + (A2(
						$elm$core$String$join,
						', ',
						A2(
							$elm$core$List$map,
			...
			default:
				var inputNode = typeAnnotation.a;
				var outputNode = typeAnnotation.b;
				var left = $stil4m$elm_syntax$Elm$Syntax$Node$value(inputNode);
				return A2(
					$elm$core$String$join,
					' -> ',
					_List_fromArray(
						[
							$author$project$Extras$ElmSyntax$isFunctionAnnotation(left) ? ('(' + (A2($author$project$Extras$ElmSyntax$fromAnnotationToStringHelper, false, left) + ')')) : A2($author$project$Extras$ElmSyntax$fromAnnotationToStringHelper, false, left),
							A2(
							$author$project$Extras$ElmSyntax$fromAnnotationToStringHelper,
							false,
							$stil4m$elm_syntax$Elm$Syntax$Node$value(outputNode))
						]));
		}
	});
var $author$project$Extras$ElmSyntax$fromRecordFieldToString = function (recordField) {
	var keyNode = recordField.a;
	var valueNode = recordField.b;
	return A2(
		$elm$core$String$join,
		' : ',
		_List_fromArray(
			[
				$stil4m$elm_syntax$Elm$Syntax$Node$value(keyNode),
				A2($elm$core$Basics$composeL, $author$project$Extras$ElmSyntax$fromAnnotationToString, $stil4m$elm_syntax$Elm$Syntax$Node$value)(valueNode)
			]));
};
var $author$project$Extras$ElmSyntax$toAnnotationForFunction = F2(
	function (functionName, file) {
		var _v0 = A2($author$project$Extras$ElmSyntax$findFunction, functionName, file);
		if (!_v0.$) {
			var _function = _v0.a;
			var _v1 = _function.b_;
			if (!_v1.$) {
				var node = _v1.a;
				var signature = $stil4m$elm_syntax$Elm$Syntax$Node$value(node);
				var typeAnnotation = $stil4m$elm_syntax$Elm$Syntax$Node$value(signature.b1);
				return $elm$core$Maybe$Just(
					$author$project$Extras$ElmSyntax$fromAnnotationToString(typeAnnotation));
			} else {
				return $elm$core$Maybe$Nothing;
			}
		} else {
...
var $author$project$Layout$toAnnotationForLayoutFunction = function (_v0) {
	var layout = _v0;
	return A2($author$project$Extras$ElmSyntax$toAnnotationForFunction, 'layout', layout._);
};
var $author$project$Layout$InvalidTypeAnnotation = 1;
var $author$project$Layout$MissingTypeAnnotation = 0;
var $author$project$Layout$toProblem = function (layout) {
	var validAnnotations = $author$project$Layout$toValidLayoutFunctionAnnotations(
		$author$project$Filepath$toParentLayoutModuleName(
			$author$project$Layout$filepath(layout)));
	var _v0 = $author$project$Layout$toAnnotationForLayoutFunction(layout);
	if (_v0.$ === 1) {
		return $elm$core$Maybe$Just(0);
	} else {
		var str = _v0.a;
		return A2($elm$core$List$member, str, validAnnotations) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(1);
	}
};
var $author$project$Error$RED = 0;
var $author$project$Error$red = function (str) {
	return $author$project$Error$StyledText(
		{
			F: false,
			G: $elm$core$Maybe$Just(0),
			L: str,
			N: false
		});
};
var $author$project$Worker$unexpectedAnnotationError = F2(
	function (_v0, options) {
		var functionName = _v0.y;
		var validAnnotations = _v0.E;
		var units = ($elm$core$List$length(validAnnotations) === 1) ? 'this annotation' : 'one of these annotations';
				...
				bQ: $elm$core$List$concat(
					_List_fromArray(
						[
							_List_fromArray(
							[
								$author$project$Error$text('I found an unexpected type annotation on this '),
								$author$project$Error$yellow(functionName),
								$author$project$Error$text(' function.\n\n'),
								$author$project$Error$text(
								A3($elm$core$String$replace, '{{functionName}}', functionName, '  {{functionName}} : ')),
								$author$project$Error$text(options.T),
								$author$project$Error$text(
								'\n' + A2(
									$elm$core$String$repeat,
									5 + $elm$core$String$length(functionName),
									' ')),
								$author$project$Error$red(
								A2(
									$elm$core$String$repeat,
									$elm$core$String$length(options.T),
									'^')),
								$author$project$Error$text(
								A3($elm$core$String$replace, '{{units}}', units, '\nI recommend {{units}}:\n\n'))
							]),
							A2(
							$elm$core$List$concatMap,
							function (anno) {
							...
							[
								$author$project$Error$text('Although Elm annotations are optional, Elm Land requires an annotation for\nthis particular function to avoid showing errors in generated code.\n\n'),
								$author$project$Error$underline('Hint:'),
								$author$project$Error$text(' Read https://elm.land/problems#unexpected-type-annotation to learn more')
							])
						])),
				bX: $author$project$Filepath$toRelativeFilepath(options.aJ),
				b0: 'Unexpected type annotation'
			});
	});
var $author$project$Worker$unexpectedLayoutAnnotationError = function (options) {
	return A2(
		$author$project$Worker$unexpectedAnnotationError,
		{
			y: 'layout',
			E: $author$project$Worker$validLayoutFunctionAnnotations(options.aJ)
		},
...
var $author$project$Worker$fromLayoutToError = function (layout) {
	if ($author$project$Layout$isNotExposingLayoutFunction(layout)) {
		return $elm$core$Maybe$Just(
			$author$project$Worker$missingFunctionError(
				{
					aJ: $author$project$Layout$filepath(layout),
					l: 'layout',
					aa: 'layout'
				}));
	} else {
		if ($author$project$Layout$isNotExposingPropsType(layout)) {
			return $elm$core$Maybe$Just(
				$author$project$Worker$missingTypeError(
					{
						aJ: $author$project$Layout$filepath(layout),
						l: 'layout',
						aa: 'Props'
			...
			if ($author$project$Layout$isNotExposingModelType(layout)) {
				return $elm$core$Maybe$Just(
					$author$project$Worker$missingTypeError(
						{
							aJ: $author$project$Layout$filepath(layout),
				...
				if ($author$project$Layout$isNotExposingMsgType(layout)) {
					return $elm$core$Maybe$Just(
						$author$project$Worker$missingTypeError(
							{
								aJ: $author$project$Layout$filepath(layout),
					...
					var _v0 = $author$project$Layout$toProblem(layout);
					if (!_v0.$) {
						if (!_v0.a) {
							var _v1 = _v0.a;
							return $elm$core$Maybe$Just(
								$author$project$Worker$missingLayoutAnnotationError(
									{
										aJ: $author$project$Layout$filepath(layout)
									}));
						} else {
							var problem = _v0.a;
							return $elm$core$Maybe$Just(
								$author$project$Worker$unexpectedLayoutAnnotationError(
									{
										T: A2(
											$elm$core$Maybe$withDefault,
											'???',
											$author$project$Layout$toAnnotationForLayoutFunction(layout)),
										aJ: $author$project$Layout$filepath(layout)
									}));
						}
					} else {
...
var $author$project$Page$filepath = function (_v0) {
	var page = _v0;
	return page.aJ;
};
var $author$project$Page$isNotExposingModelType = function (_v0) {
	var page = _v0;
	return A2($author$project$Extras$ElmSyntax$isNotExposing, 'Model', page._);
};
var $author$project$Page$isNotExposingMsgType = function (_v0) {
	var page = _v0;
	return A2($author$project$Extras$ElmSyntax$isNotExposing, 'Msg', page._);
};
var $author$project$Page$isNotExposingPageFunction = function (_v0) {
	var page = _v0;
	return A2($author$project$Extras$ElmSyntax$isNotExposing, 'page', page._);
};
var $author$project$Page$Stateful = 1;
var $author$project$Page$PageFunctionExpectedFunctionReturningPage = 4;
var $author$project$Page$PageFunctionExpectedRouteParams = 5;
var $author$project$Page$PageFunctionExpectedSharedModel = 6;
var $author$project$Page$PageFunctionExpectedTypeOrFunction = 2;
var $author$project$Page$PageFunctionExpectedViewOrPageValue = 3;
var $author$project$Page$PageFunctionMissingTypeAnnotation = 1;
var $author$project$Page$PageFunctionNotFound = 0;
var $author$project$Page$Static = 0;
var $author$project$Page$toPageKind = function (_v0) {
	var page = _v0;
	var _v1 = A2($author$project$Extras$ElmSyntax$findFunction, 'page', page._);
	if (_v1.$ === 1) {
		return $elm$core$Result$Err(0);
	} else {
		var signature = _v1.a.b_;
		var toValue = $stil4m$elm_syntax$Elm$Syntax$Node$value;
		var isValidParams = F2(
			function (filepath_, params) {
				return _Utils_eq(
					$author$project$Extras$ElmSyntax$fromAnnotationToString(params),
					$author$project$Filepath$toRouteParamsRecordString(filepath_));
			});
		var isModuleNamed = F2(
			function (str, _v18) {
				var xs = _v18.a;
				var x = _v18.b;
				return _Utils_eq(
		...
		var isRouteWithParamsMatching = F2(
			function (filepath_, annotation) {
				if (((annotation.$ === 1) && annotation.b.b) && (!annotation.b.b.b)) {
					var node = annotation.a;
					var _v17 = annotation.b;
					var paramsArg = _v17.a;
					return A2(
						isModuleNamed,
						'Route',
						toValue(node)) && A2(
		...
		var isSharedModel = function (annotation) {
			if ((annotation.$ === 1) && (!annotation.b.b)) {
				var node = annotation.a;
				return A2(
					isModuleNamed,
					'Shared.Model',
		...
		var isModelAndMsg = function (nodes) {
			var _v11 = A2($elm$core$List$map, toValue, nodes);
			if ((((_v11.b && (_v11.a.$ === 1)) && _v11.b.b) && (_v11.b.a.$ === 1)) && (!_v11.b.b.b)) {
				var _v12 = _v11.a;
				var modelVar = _v12.a;
				var _v13 = _v11.b;
				var _v14 = _v13.a;
		...
		var isPageModelMsg = function (annotation) {
			if (annotation.$ === 1) {
				var node = annotation.a;
				...
				return A2(
					isModuleNamed,
					'Page',
					toValue(node)) && isModelAndMsg(vars);
			} else {
				return false;
			}
		};
		var isGenericMsgType = function (anno) {
			if ((!anno.$) && (anno.a === 'msg')) {
				return true;
			} else {
				return false;
		...
		var isViewMsg = function (annotation) {
			if (annotation.$ === 1) {
				var node = annotation.a;
				var vars = annotation.b;
				return A2(
					...
					A2(
						$elm$core$Maybe$map,
						A2($elm$core$Basics$composeR, toValue, isGenericMsgType),
						$elm$core$List$head(vars)));
			} else {
				return false;
			}
		};
		var isAuthUser = function (annotation) {
			if ((annotation.$ === 1) && (!annotation.b.b)) {
				var node = annotation.a;
				return A2(
					isModuleNamed,
		...
		var findSharedRoutePageFunction = function (annotation) {
			if (annotation.$ === 6) {
				var left2 = annotation.a;
				var right2 = annotation.b;
				if (isSharedModel(
					toValue(left2))) {
					var _v5 = toValue(right2);
					if (_v5.$ === 6) {
						var left3 = _v5.a;
						var right3 = _v5.b;
						if (A2(
							isRouteWithParamsMatching,
							page.aJ,
							toValue(left3))) {
							var _v6 = toValue(right3);
							if (_v6.$ === 1) {
								var node = _v6.a;
								var vars = _v6.b;
								return (A2(
									isModuleNamed,
									'Page',
									toValue(node)) && isModelAndMsg(vars)) ? $elm$core$Result$Ok(1) : $elm$core$Result$Err(3);
							} else {
		...
		if (_v2.$ === 1) {
			...
			switch (typeAnnotation.$) {
				case 1:
					var node = typeAnnotation.a;
					var vars = typeAnnotation.b;
					return isViewMsg(typeAnnotation) ? $elm$core$Result$Ok(0) : (isPageModelMsg(typeAnnotation) ? $elm$core$Result$Ok(1) : $elm$core$Result$Err(3));
				case 6:
					var left1 = typeAnnotation.a;
					var right1 = typeAnnotation.b;
					return A2(
						isValidParams,
						page.aJ,
						toValue(left1)) ? (isViewMsg(
						toValue(right1)) ? $elm$core$Result$Ok(0) : (isPageModelMsg(
						toValue(right1)) ? $elm$core$Result$Ok(1) : $elm$core$Result$Err(2))) : (isAuthUser(
						toValue(left1)) ? findSharedRoutePageFunction(
						toValue(right1)) : findSharedRoutePageFunction(typeAnnotation));
				default:
...
var $author$project$Page$isStatefulPage = function (page) {
	return _Utils_eq(
		$author$project$Page$toPageKind(page),
		$elm$core$Result$Ok(1));
};
var $author$project$Worker$toValidPageFunctionAnnotations = function (filepath) {
	var params = $author$project$Filepath$toRouteParamsRecordString(filepath);
	return _List_fromArray(
		[
			function () {
			if (params === '()') {
				...
				return A3($elm$core$String$replace, '{{params}}', params, '{{params}} -> View msg');
			}
		}(),
			'Page Model Msg',
			A3($elm$core$String$replace, '{{params}}', params, 'Shared.Model -> Route {{params}} -> Page Model Msg'),
			A3($elm$core$String$replace, '{{params}}', params, 'Auth.User -> Shared.Model -> Route {{params}} -> Page Model Msg')
		]);
};
var $author$project$Worker$missingPageAnnotationError = function (options) {
	return A2(
		$author$project$Worker$missingFunctionAnnotationError,
		{
			y: 'page',
			E: $author$project$Worker$toValidPageFunctionAnnotations(options.aJ)
		},
		options);
};
var $author$project$Page$toAnnotationForPageFunction = function (_v0) {
	var page = _v0;
	return A2($author$project$Extras$ElmSyntax$toAnnotationForFunction, 'page', page._);
};
var $author$project$Page$toProblem = function (page) {
	var _v0 = $author$project$Page$toPageKind(page);
	if (_v0.$ === 1) {
		var problem = _v0.a;
...
var $author$project$Worker$unexpectedPageAnnotationError = function (options) {
	return A2(
		$author$project$Worker$unexpectedAnnotationError,
		{
			y: 'page',
...
var $author$project$Worker$fromPageToError = function (page) {
	if ($author$project$Page$isNotExposingPageFunction(page)) {
		return $elm$core$Maybe$Just(
			$author$project$Worker$missingFunctionError(
				{
					aJ: $author$project$Page$filepath(page),
					l: 'function',
					aa: 'page'
				}));
	} else {
		var _v0 = $author$project$Page$toProblem(page);
		if (!_v0.$) {
			if (_v0.a === 1) {
				var _v1 = _v0.a;
				return $elm$core$Maybe$Just(
					$author$project$Worker$missingPageAnnotationError(
						{
							aJ: $author$project$Page$filepath(page)
						}));
			} else {
				var problem = _v0.a;
				return $elm$core$Maybe$Just(
					$author$project$Worker$unexpectedPageAnnotationError(
						{
							T: A2(
								$elm$core$Maybe$withDefault,
								'???',
								$author$project$Page$toAnnotationForPageFunction(page)),
							aJ: $author$project$Page$filepath(page)
						}));
			}
		} else {
			return ($author$project$Page$isStatefulPage(page) && $author$project$Page$isNotExposingModelType(page)) ? $elm$core$Maybe$Just(
				$author$project$Worker$missingTypeError(
					{
						aJ: $author$project$Page$filepath(page),
						l: 'page',
						aa: 'Model'
					})) : (($author$project$Page$isStatefulPage(page) && $author$project$Page$isNotExposingMsgType(page)) ? $elm$core$Maybe$Just(
				$author$project$Worker$missingTypeError(
					{
						aJ: $author$project$Page$filepath(page),
						l: 'page',
...
var $author$project$CustomizableFile$filepath = function (_v0) {
	var file = _v0;
	return file.aJ;
};
var $author$project$CustomizableFile$InvalidTypeAnnotation = function (a) {
	return {$: 1, a: a};
};
var $author$project$CustomizableFile$MissingTypeAnnotation = {$: 0};
var $author$project$CustomizableFile$toAnnotationForFunction = F2(
	function (functionName, _v0) {
		var file = _v0;
		return A2($author$project$Extras$ElmSyntax$toAnnotationForFunction, functionName, file._);
	});
var $author$project$CustomizableFile$findProblemWithFunctionAnnotation = function (_v0) {
	var name = _v0.aa;
	var expected = _v0.bE;
	var file = _v0._;
	var _v1 = A2($author$project$CustomizableFile$toAnnotationForFunction, name, file);
	if (_v1.$ === 1) {
		return $elm$core$Maybe$Just($author$project$CustomizableFile$MissingTypeAnnotation);
	} else {
		var actual = _v1.a;
		return _Utils_eq(actual, expected) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(
			$author$project$CustomizableFile$InvalidTypeAnnotation(actual));
	}
};
var $author$project$CustomizableFile$isNotExposing = F2(
	function (name, _v0) {
		var file = _v0;
		return A2($author$project$Extras$ElmSyntax$isNotExposing, name, file._);
	});
var $author$project$Worker$toCustomizableErrors = F2(
	function (maybe, options) {
		if (maybe.$ === 1) {
			return $elm$core$Maybe$Nothing;
		} else {
			var file = maybe.a;
			var firstTypeNotExposed = $elm$core$List$head(
				A2(
					$elm$core$List$filter,
					function (typeName) {
						return A2($author$project$CustomizableFile$isNotExposing, typeName, file);
					},
					options.M));
			var firstFunctionWithMissingAnnotation = $elm$core$List$head(
				A2(
					$elm$core$List$filterMap,
					function (_v5) {
						var name = _v5.a;
						...
						return A2(
							$elm$core$Maybe$map,
							$elm$core$Tuple$pair(
								_Utils_Tuple2(name, anno)),
							$author$project$CustomizableFile$findProblemWithFunctionAnnotation(
								{bE: anno, _: file, aa: name}));
					},
					options.z));
			var firstFunctionNotExposed = A2(
				$elm$core$Maybe$map,
				$elm$core$Tuple$first,
				$elm$core$List$head(
					A2(
						...
						function (_v4) {
							var name = _v4.a;
							return A2($author$project$CustomizableFile$isNotExposing, name, file);
						},
						options.z)));
			return $elm$core$List$head(
				A2(
					...
					_List_fromArray(
						[
							...
							$elm$core$Maybe$map,
							function (typeName) {
								return $author$project$Worker$missingTypeError(
									{
										aJ: $author$project$CustomizableFile$filepath(file),
										l: 'customized',
										aa: typeName
									});
							},
							...
							$elm$core$Maybe$map,
							function (name) {
								return $author$project$Worker$missingFunctionError(
									{
										aJ: $author$project$CustomizableFile$filepath(file),
										l: 'customized',
										aa: name
...
var $author$project$Error$fromColorToString = function (color) {
	switch (color) {
		case 0:
			return 'RED';
		case 1:
...
var $author$project$Error$fromMessageToJson = function (message) {
	if (!message.$) {
		var str = message.a;
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'bold',
					$elm$json$Json$Encode$bool(item.F)),
					_Utils_Tuple2(
					'underline',
					$elm$json$Json$Encode$bool(item.N)),
					_Utils_Tuple2(
					'color',
					function () {
						var _v1 = item.G;
						if (!_v1.$) {
							...
							return $elm$json$Json$Encode$string(
								$author$project$Error$fromColorToString(someColor));
						} else {
...
var $author$project$Error$toJson = function (_v0) {
	var error = _v0;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				$elm$json$Json$Encode$string(
					$elm$core$String$toUpper(error.b0))),
				_Utils_Tuple2(
				'message',
				A2($elm$json$Json$Encode$list, $author$project$Error$fromMessageToJson, error.bQ))
			]));
};
var $author$project$Worker$init = function (flags) {
	...
	var layouts = A2(
		...
		A2(
			...
			A2(
				$elm$json$Json$Decode$field,
				'layouts',
				$elm$json$Json$Decode$list($author$project$Layout$decoder)),
			flags));
	var errorsFromPages = A2($elm$core$List$filterMap, $author$project$Worker$fromPageToError, pages);
	var errorsFromLayouts = A2($elm$core$List$filterMap, $author$project$Worker$fromLayoutToError, layouts);
	var customizedFiles = A2(
		$elm$core$Result$withDefault,
		{ae: $elm$core$Maybe$Nothing, ag: $elm$core$Maybe$Nothing, ao: $elm$core$Maybe$Nothing, ap: $elm$core$Maybe$Nothing, aq: $elm$core$Maybe$Nothing, av: $elm$core$Maybe$Nothing},
		A2($elm$json$Json$Decode$decodeValue, $author$project$Worker$customizedFilesDecoder, flags));
	var errorsFromCustomizedFiles = A2(
		$elm$core$List$filterMap,
		$elm$core$Basics$identity,
		_List_fromArray(
			[
				A2(
				$author$project$Worker$toCustomizableErrors,
				customizedFiles.ae,
				{
					z: _List_fromArray(
						[
							_Utils_Tuple2('onPageLoad', 'Shared.Model -> Route () -> Auth.Action.Action User'),
							_Utils_Tuple2('viewCustomPage', 'Shared.Model -> Route () -> View Never')
						]),
					M: _List_fromArray(
						['User'])
				}),
				...
				customizedFiles.ao,
				{
					z: _List_fromArray(
						[
							_Utils_Tuple2('decoder', 'Json.Decode.Decoder Flags'),
							_Utils_Tuple2('init', 'Result Json.Decode.Error Flags -> Route () -> ( Model, Effect Msg )'),
							_Utils_Tuple2('update', 'Route () -> Msg -> Model -> ( Model, Effect Msg )'),
							_Utils_Tuple2('subscriptions', 'Route () -> Model -> Sub Msg')
						]),
					M: _List_fromArray(
						['Flags', 'Model', 'Msg'])
				}),
				...
				customizedFiles.ag,
				{
					z: _List_fromArray(
						[
							_Utils_Tuple2('none', 'Effect msg'),
							_Utils_Tuple2('map', '(msg1 -> msg2) -> Effect msg1 -> Effect msg2'),
							_Utils_Tuple2('toCmd', '{ key : Browser.Navigation.Key, url : Url, shared : Shared.Model.Model, fromSharedMsg : Shared.Msg.Msg -> msg, batch : List msg -> msg, toCmd : msg -> Cmd msg } -> Effect msg -> Cmd msg'),
							_Utils_Tuple2('sendCmd', 'Cmd msg -> Effect msg'),
							_Utils_Tuple2('replaceRoute', '{ path : Route.Path.Path, query : Dict String String, hash : Maybe String } -> Effect msg'),
							_Utils_Tuple2('pushRoute', '{ path : Route.Path.Path, query : Dict String String, hash : Maybe String } -> Effect msg')
						]),
					M: _List_fromArray(
						['Effect'])
				}),
				...
				customizedFiles.av,
				{
					z: _List_fromArray(
						[
							_Utils_Tuple2('toBrowserDocument', '{ shared : Shared.Model.Model, route : Route (), view : View msg } -> Browser.Document msg'),
							_Utils_Tuple2('map', '(msg1 -> msg2) -> View msg1 -> View msg2'),
							_Utils_Tuple2('none', 'View msg'),
							_Utils_Tuple2('fromString', 'String -> View msg')
						]),
					M: _List_fromArray(
						['View'])
				})
	...
	return _Utils_Tuple2(
		{},
		$author$project$Worker$onComplete(
			A2(
				$elm$core$List$map,
				$author$project$Error$toJson,
				_Utils_ap(
					errorsFromPages,
					_Utils_ap(errorsFromLayouts, errorsFromCustomizedFiles)))));
};
...
var $author$project$Worker$main = $elm$core$Platform$worker(
	{bN: $author$project$Worker$init, b$: $author$project$Worker$subscriptions, b2: $author$project$Worker$update});
_Platform_export({'Worker':{'init':$author$project$Worker$main($elm$json$Json$Decode$value)(0)}});}(this));